...
describe('Player makes move command', function(){
  ...
  describe('game ends in draw', function(){
    it('should let game end in draw', function(){
      given.push(
        {event: "PlayerMadeMove", x: 0, y: 0, player: 'X'},
        {event: "PlayerMadeMove", x: 0, y: 1, player: 'O'},
        {event: "PlayerMadeMove", x: 0, y: 2, player: 'X'},
        {event: "PlayerMadeMove", x: 1, y: 0, player: 'O'},
        {event: "PlayerMadeMove", x: 1, y: 1, player: 'X'},
        {event: "PlayerMadeMove", x: 2, y: 0, player: 'O'},
        {event: "PlayerMadeMove", x: 1, y: 2, player: 'X'},
        {event: "PlayerMadeMove", x: 2, y: 2, player: 'O'});
